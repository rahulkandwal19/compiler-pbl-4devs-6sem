...
public:
    ...
    //######################################### Code Generator #############################################
    void generate(std::shared_ptr<ProgramNode> program, bool debugMode = false, bool prettyPrint = false) {
        this->debugMode = debugMode;
        this->prettyPrint = prettyPrint;
        
        out << "// Generated by AutomonScript Compiler\n";
        if (debugMode) {
...
private:
    ...
    void writeIndent() {
        for (int i = 0; i < indentLevel * 4; i++) out << " ";
    }
};